 ...
 * @category Server
 */
export type UpdateSession = (...args: [IncomingMessage, ServerResponse, Session] | [NextApiRequest, NextApiResponse, Session] | [NextRequest, NextResponse, Session] | [Session]) => Promise<void>;
/**
 * @ignore
 */
